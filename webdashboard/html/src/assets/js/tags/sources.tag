  ...
  <div id="accordion">
    <div class="card">
      <div class="card-header" id="cameraServerHeader">
        <h5 class="mb-0">
          <button class="btn btn-link" data-toggle="collapse" data-target="#cameraServerBody" aria-expanded="true" aria-controls="cameraServerBody">
            CameraServer
          </button>
        </h5>
      </div>

      <div id="cameraServerBody" class="collapse show" aria-labelledby="cameraServerHeader" data-parent="#accordion">
        <div class="card-body">
